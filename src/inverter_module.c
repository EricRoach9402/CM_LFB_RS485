...
static void unit_set_connection(inverter_unit_t *unit, int state);
...
int start_inverter_modules(module_config_t inverters[], int inverter_count)
{
    ...
    for (int i = 0; i < inverter_count; i++) {
        ...
        pool_write_register(int_inverter_connection_status_reg,
...
static void unit_set_connection(inverter_unit_t *unit, int state)
{
    ...
    pool_write_register(int_inverter_connection_status_reg, (uint16_t)state);
}
