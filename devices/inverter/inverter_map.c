/**
 * @file inverter_map.c
 * @brief Inverter1 register map (pool base 0xA000).
 *
 ...
 *
 * Default pool block for Inverter1 (0xA000). Each additional unit needs its own pool base.
 */
...
static const device_register_mapping_t inverter1_mapping_table[] = {
    ...
    { 0x0014,  0xA100,  ACCESS_RW,  "frequency_cmd_souce" },
    { 0x0015,  0xA101,  ACCESS_RW,  "run_cmd_souce" },
    ...
    { 0x0D00,  0xA001,  ACCESS_RO,  "parament_mode" },
    ...
    { 0x220A,  0xA009,  ACCESS_RO,  "pid_feedback value" },
...
const uint16_t int_frequency_cmd_souce_reg = 0xA100;
const uint16_t int_run_cmd_souce_reg = 0xA101;
...
const uint16_t dev_frequency_cmd_souce_reg = 0x0014;
const uint16_t dev_run_cmd_souce_reg = 0x0015;
...
/* Steady-state setpoints only; exclude pulse/edge registers like fault_control. */
